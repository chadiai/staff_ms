...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-regal-blue text-md font-medium leading-5 text-gray-900 focus:outline-none focus:border-regal-blue-dark transition duration-150 ease-in-out'
