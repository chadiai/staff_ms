                                    ...
                                    <span
                                        ...
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span style="background-color: #5FB2D3;"
                                                      class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white border border-gray-300 cursor-default leading-5 select-none">{{ $page }}</span>
                                            </span>
                                        @else
                                            <button type="button"
