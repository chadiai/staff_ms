...
class MealPlan extends Model
{
    ...
    {
        return $this->belongsTo(MealType::class)->withDefault();  // a mealPlan belongs to a mealType
    }

    public function meal()
    {
        return $this->belongsTo(Meal::class)->withDefault();  // a meal belongs to a mealType
    }

    public function meal_subscriptions()
    {
        return $this->hasMany(MealSubscription::class);   // a mealPlan has many mealSubscriptions
    }
    /**
