...
class EventCreationRequest extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(User::class)->withDefault();  // a record belongs to a genre
    }
    public function recurrence()
    {
        return $this->belongsTo(Recurrence::class)->withDefault();  // a record belongs to a genre
    }
    public function events()
    {
        return $this->hasMany(Event::class);   // a genre has many records
    }
