...
class MealSubscription extends Model
{
    ...
    {
        return $this->belongsTo(MealPlan::class)->withDefault();  // a mealSubscription belongs to a mealPlan
    }

    public function user()
    {
        return $this->belongsTo(User::class)->withDefault();  // a mealSubscription belongs to a user
    }
